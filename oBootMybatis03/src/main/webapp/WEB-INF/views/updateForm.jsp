...
<body>
	...
	<form action="update" method="post">
		...
		<table>
			...
			<tr><th>업무</th><td><input type="text" name="job" value="${emp.job }"></td></tr>
			<tr><th>급여</th><td><input type="number" name="sal" value="${emp.sal }"></td></tr>
			...
			<tr><th>부서코드</th><td><input type="number" name="deptno" value="${emp.deptno }"></td></tr>
			<tr><td colspan="2">
