...
public class MemberController {
	...
	public String memberModify(Long id, Model model) {
		...
		System.out.println("MemberController memberModify 2");
		member2.setName(member.get().getName());
		System.out.println("MemberController memberModify 3");
		member2.setTeam(member.get().getTeam());
		System.out.println("MemberController memberModify 4");
